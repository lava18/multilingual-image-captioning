...
for adobe_id in adobe_ids:
    #@title Inference
    use_beam_search = False #@param {type:"boolean"}  

    image = io.imread("images/{}".format(adobe_id))
    ...
    english_captions.append(generated_text_prefix)

with open("generated_english_captions_no_beam.txt", "w") as fp:
    fp.write("\n".join(english_captions))
